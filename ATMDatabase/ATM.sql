...
-- Table `atm`.`person`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `atm`.`person` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `atm`.`account_card`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `atm`.`account_card` (
  `account_ID` INT NOT NULL,
  `card_ID` INT NOT NULL,
  INDEX `fk_account_card_account1_idx` (`account_ID` ASC) VISIBLE,
  INDEX `fk_account_card_card1_idx` (`card_ID` ASC) VISIBLE,
  CONSTRAINT `fk_account_card_account1`
    FOREIGN KEY (`account_ID`)
    REFERENCES `atm`.`account` (`ID`),
  CONSTRAINT `fk_account_card_card1`
    FOREIGN KEY (`card_ID`)
...
-- Table `atm`.`machine`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `atm`.`machine` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(64) NOT NULL,
  `salt` VARCHAR(20) NOT NULL,
  `hash` VARCHAR(20) NOT NULL,
...
-- -----------------------------------------------------
-- Table `atm`.`person-account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `atm`.`person-account` (
  `person_ID` INT NOT NULL,
  `account_ID` INT NOT NULL,
  INDEX `fk_person-account_person_idx` (`person_ID` ASC) VISIBLE,
  INDEX `fk_person-account_account1_idx` (`account_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `opisk_t9ylan01`.`owner` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE INDEX `ID_UNIQUE` (`ID` ASC) VISIBLE,
  UNIQUE INDEX `ss_number_UNIQUE` (`ss_number` ASC) VISIBLE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `opisk_t9ylan01`.`card` (
  ...
  INDEX `fk_card_person1_idx` (`owner_ID` ASC) VISIBLE,
  UNIQUE INDEX `person_ID_UNIQUE` (`owner_ID` ASC) VISIBLE,
  CONSTRAINT `fk_card_person1`
...
CREATE TABLE IF NOT EXISTS `opisk_t9ylan01`.`account-card` (
  `account_ID` INT NOT NULL,
  `card_ID` INT NOT NULL,
  INDEX `fk_account-card_account1_idx` (`account_ID` ASC) VISIBLE,
  INDEX `fk_account-card_card1_idx` (`card_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `opisk_t9ylan01`.`machine` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE INDEX `ID_UNIQUE` (`ID` ASC) VISIBLE,
  INDEX `fk_machine_owner1_idx` (`owner_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `opisk_t9ylan01`.`owner-account` (
  `owner_ID` INT NOT NULL,
  `account_ID` INT NOT NULL,
  INDEX `fk_person-account_person_idx` (`owner_ID` ASC) VISIBLE,
  INDEX `fk_person-account_account1_idx` (`account_ID` ASC) VISIBLE,
  CONSTRAINT `fk_person-account_account1`
    FOREIGN KEY (`account_ID`)
    REFERENCES `opisk_t9ylan01`.`account` (`ID`),
...
CREATE TABLE IF NOT EXISTS `opisk_t9ylan01`.`transaction` (
  ...
  INDEX `fk_transaction_account2_idx` (`other_account_ID` ASC) VISIBLE,
  INDEX `fk_transaction_transaction1_idx` (`other_transaction_ID` ASC) VISIBLE,
